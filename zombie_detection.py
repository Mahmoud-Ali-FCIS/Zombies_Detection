# -*- coding: utf-8 -*-
"""Zombie Detection.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jrljCh-dXaFc2OYVw_6RMsZ7_1vu8IVG
...
for i in range(1, 6): # @REPLACE for i in range(None, None)
    ...
    image_path = os.path.join('training',f'training-zombie{i}.jpg')
    print(image_path)
...
def train_step_fn(image_list,
    ...
    ### START CODE HERE (Replace instances of `None` with your code) ###
        ...
        preprocessed_image_tensor = tf.concat(
                                                                        [detection_model.preprocess(img)[0]
                                                                        for img in image_list], axis=0)
        ...
        loss_dic=model.loss(prediction_dict,true_shape_tensor)
        
        total_loss =loss_dic['Loss/localization_loss'] + loss_dic['Loss/classification_loss']
